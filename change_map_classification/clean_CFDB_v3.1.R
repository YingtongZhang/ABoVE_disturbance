...
map_dir = "/projectnb/landsat/users/shijuan/above/out_class_sample/"%+%tile_name%+%"/"
out_dir = "/projectnb/landsat/users/shijuan/above/post_process/clean_CFDB_v3/"%+%tile_name%+%"/"
lc_dir = "/projectnb/modislc/users/jonwang/data/rf/rast/tc_20180416_noGeo_k55_pam_rf/"%+%tile_name%+%"/old_remap/"

map_name <- paste0(map_dir, "Bh09v15_FF_FN_NF_NN_2006_cl.tif")
...
##save the files
output_fire1 = paste(out_dir, "2006_FNin",".tif", sep="")
writeRaster(x_FNin, output_fire1, format="GTiff", overwrite=TRUE)
output_fire2 = paste(out_dir, "2006_FNout",".tif", sep="")
...
output_file = paste(out_dir, "2006_FF_FN_NF_NN_ppv2",".tif", sep="")
